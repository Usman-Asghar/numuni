                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo $this->lang->line('recent_invoices') ?> <a
                                        href="<?php echo base_url() ?>rec_invoices/create"
                                        class="btn btn-primary btn-sm rounded"><?php echo $this->lang->line('Add Sale') ?></a> <a
                                        href="<?php echo base_url() ?>rec_invoices"
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    foreach ($recent as $item) {
                                        echo '<tr>
                                <td class="text-truncate"><a href="' . base_url() . 'rec_invoices/view?id=' . $item['tid'] . '">#' . $item['tid'] . '</a></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-1">
                                    ...
                                    foreach ($recent_payments as $item) {
                                        echo '<tr>
                                <td class="text-truncate"><a href="' . base_url() . 'transactions/view?id=' . $item['id'] . '">' . $item['date'] . '</a></td>
